...
// 鈹€鈹€鈹€ PDF Generation 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€

func generatePDF(task *Task) (string, error) {
	html := renderHTML(task)
	tmpHTML := filepath.Join(os.TempDir(), "orion_"+task.ID+".html")
	if err := os.WriteFile(tmpHTML, []byte(html), 0644); err != nil {
		return "", err
	}
	defer os.Remove(tmpHTML)

	pdfPath := filepath.Join(os.TempDir(), "orion_"+task.ID+".pdf")
...
<h1>ORION 瀹夊叏鎵弿鎶ュ憡</h1>
<div class="meta">
  <p><strong>浠诲姟ID:</strong> ` + t.ID + ` &nbsp; <strong>URL:</strong> ` + t.URL + ` &nbsp; <strong>绫诲瀷:</strong> ` + t.ScanType + `</p>
  <p><strong>鐘舵€?</strong> ` + t.Status + ` &nbsp; <strong>鏃堕棿:</strong> ` + t.CreatedAt.Format("2006-01-02 15:04:05") + `</p>
</div>
<table><thead><tr><th>绫诲瀷</th><th>URL</th><th>璇︽儏</th><th>Master</th></tr></thead><tbody>` + rows + `</tbody></table></body></html>`
}
